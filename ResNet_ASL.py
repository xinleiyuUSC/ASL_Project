...
def resNet50():
    ...
    learning_rates=[0.0001,0.00001] #0.01 0.001
    t = time.localtime()
    current_time = time.strftime("%H:%M:%S", t)
    print(current_time)
    ...
    for l_rate in learning_rates:
        ...
        Model_train(15, train_loader,resnet_model,
...
def resNet18():
    ...
    resnet_18.to(device)
    #summary(resnet_model, (3, 200, 200), batch_size=100)
    learning_rates=[0.01,0.001,0.00001] #0.01 0.001
    t = time.localtime()
    current_time = time.strftime("%H:%M:%S", t)
    print(current_time)
    print("Start to train" )
    ...
    for l_rate in learning_rates:
        ...
        optimizer_resnet=torch.optim.Adam(resnet_18.parameters(),
                                        lr=l_rate,weight_decay=0.0001)
        Model_train(15, train_loader,resnet_18,
                    loss_function_resnet,optimizer_resnet)
